...
const PLAYER_BUS_NAME: &str = "dev.daniacosta.AuroraWall.Player";
const PLAYER_OBJECT_PATH: &str = "/dev/daniacosta/AuroraWall/Player";
const PLAYER_INTERFACE: &str = "dev.daniacosta.AuroraWall.Player";
...
fn launch_player() {
    // Look for the player next to our own binary first, then fall back to PATH.
